...
class PIndex(Index):
    ...
    def get_poem(self, p):
        ...
        # IMPLEMENTATION
        # ---- start your code ---- #
        romenow=self.int2roman[p]
        romenow=romenow+'.'
        linenow=self.search(romenow)[0]

        romenext=self.int2roman[p+1]
        romenext=romenext+'.'
        linenext=self.search(romenext)[0]
        
        for i in self.msgs[linenow:linenext]:
            poem.append(i)
        # ---- end of your code --- #
        return poem
